    ...
    private Goal placementGoal(BlockPos pos, BuilderCalculationContext bcc) {
        ...
        for (EnumFacing facing : Movement.HORIZONTALS_BUT_ALSO_DOWN_____SO_EVERY_DIRECTION_EXCEPT_UP) {
			...
			/* ********OpenRefactory Warning********
			 ...
			 Path: 
				File: BuilderProcess.java, Line: 739
					bcc.getSchematic(pos.getX(),pos.getY(),pos.getZ(),current).getBlock()
					Method getSchematic may return null and is referenced in method invocation.
